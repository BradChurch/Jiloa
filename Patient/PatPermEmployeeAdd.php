...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") and isset($_POST['employee'])) {
...
// Select list of patients with same last name as the dependent's lat name for sellection in DDL
mysql_select_db($database_swmisconn, $swmisconn);
...
<body>
<h2>For Patient: <?php echo $_GET['lastname'] ?>, <?php echo $_GET['firstname'] ?></h2>
...
?>
        ...
        <tr>
          ...
          <td align="right" nowrap><input type="submit" name="button2" id="button" value="ADD">
